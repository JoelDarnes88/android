    ...
    public void onStart() {
        ...
        binding.spinnerServei.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                nomServei = parentView.getItemAtPosition(position).toString();
            }
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Objects.equals(nomServei, "Escollir tipus servei")) Toast.makeText(getContext(), "Servei no escollit", Toast.LENGTH_LONG).show();
                else {
                    ...
                    RequestBody servei = RequestBody.create(MediaType.parse("multipart/form-data"), nomServei);
